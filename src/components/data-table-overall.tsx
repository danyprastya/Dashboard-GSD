...
export function DataTableOverall({ selectedYear }: DataTableOverallProps) {
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute(
      "download",
      `detail_${dialogParams.kawasan}_${dialogParams.bulan}_${dialogParams.period}_${dialogParams.status}.csv`
    );
  ...
  const renderClickableBadge = (
    ...
    return (
      <span
        ...
        onClick={(e) =>
          isClickable &&
          handleBadgeClick(kawasan, bulan, period, status, count, e)
        }
        title={
          isClickable ? `Klik untuk lihat ${count} gedung` : "Tidak ada data"
        }
      >
        {count}
      </span>
    ...
    return filteredData.reduce(
      (acc, item) => ({
        ...
        period_21_30: {
          ...
          not_approved:
            acc.period_21_30.not_approved + item.period_21_30.not_approved,
  ...
  return (
    <Card suppressHydrationWarning>
      <CardHeader>
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <CardDescription>
              Detail data per bulan untuk tahun {selectedYear}
            </CardDescription>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              {[...Array(8)].map((_, i) => (
                <div
                  key={i}
                  className="flex gap-2 p-4 border-b last:border-b-0"
                >
              ...
              <Table containerClassName="overflow-visible">
                <TableHeader className="sticky top-0 z-10 bg-gray-50 shadow-sm">
                  <TableRow>
                    <TableHead
                      rowSpan={2}
                      className="font-semibold align-middle border-r w-[180px] bg-gray-50"
                    >
                      Bulan
                    </TableHead>
                    <TableHead
                      rowSpan={2}
                      className="text-center font-semibold align-middle border-r w-[100px] bg-gray-50"
                    >
                      Checklist
                    </TableHead>
                    <TableHead
                      colSpan={3}
                      className="text-center font-semibold border-r bg-blue-50"
                    >
                      Periode 1-20
                    </TableHead>
                    <TableHead
                      colSpan={5}
                      className="text-center font-semibold bg-purple-50"
                    >
                      Periode 21-30
                    </TableHead>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableHead className="text-center font-semibold border-t text-xs bg-blue-50">
                      Open
                    </TableHead>
                    <TableHead className="text-center font-semibold text-xs bg-blue-50">
                      Submitted
                    </TableHead>
                    <TableHead className="text-center font-semibold text-xs border-r bg-blue-50">
                      Approved
                    </TableHead>

                    {/* Periode 21-30 Sub Headers */}
                    <TableHead className="text-center font-semibold text-xs bg-purple-50">
                      None
                    </TableHead>
                    <TableHead className="text-center font-semibold text-xs bg-purple-50">
                      Error
                ...
                <TableBody>
                    ...
                    <React.Fragment key={index}>
                      ...
                      >
                        ...
                        <TableCell className="text-center">
                          <span
                            className={`inline-flex items-center justify-center min-w-[40px] px-2 py-1 rounded-full ${
                              item.period_1_20.open > 0
                        ...
                        <TableCell className="text-center">
                          <span
                            className={`inline-flex items-center justify-center min-w-[40px] px-2 py-1 rounded-full ${
                              item.period_21_30.not_approved > 0
                                ? "bg-red-100 text-red-800"
                                : "bg-gray-100 text-gray-400"
                            } text-sm font-medium`}
                          >
                      ...
                      {expandedMonths.has(item.bulan) &&
                        item.breakdown.map((kawasan, kawasanIdx) => (
                          <TableRow
                            key={`${index}-${kawasanIdx}`}
                          ...
                          >
                            <TableCell className="border-r w-[180px]">
                              <div className="flex items-center gap-2 pl-6">
                                ...
                                <span className="text-gray-600 text-sm">
                                  {kawasanDisplayMap[kawasan.kawasan] ||
                                    kawasan.kawasan}
                                </span>
                              </div>
                            </TableCell>
                            ...
                            <TableCell className="text-center">
                              {renderClickableBadge(
                                ...
                                kawasan.period_1_20.submitted > 0
                            ...
                            <TableCell className="text-center border-r">
                              {renderClickableBadge(
                                ...
                                kawasan.period_1_20.approved > 0
                            ...
                            <TableCell className="text-center">
                              {renderClickableBadge(
                                ...
                                kawasan.period_21_30.not_approved > 0
                                  ? "bg-red-50 text-red-700"
                                  : "bg-gray-50 text-gray-400",
                                kawasan.kawasan,
                                item.bulan,
                            ...
                            <TableCell className="text-center">
                              {renderClickableBadge(
                                ...
                                kawasan.period_21_30.approved > 0
                                  ? "bg-green-50 text-green-700"
                                  : "bg-gray-50 text-gray-400",
                                kawasan.kawasan,
                                item.bulan,
                            ...
                            <TableCell className="text-center">
                              {renderClickableBadge(
                                ...
                                kawasan.period_21_30.not_found > 0
                  ...
                  <TableRow className="bg-gray-100 font-semibold border-t-2">
                    <TableCell className="font-bold border-r w-[180px]">
                      TOTAL
                    </TableCell>
                    <TableCell className="text-center border-r w-[100px]">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent
          suppressHydrationWarning
          className="max-w-[95vw] lg:max-w-6xl max-h-[90vh] flex flex-col p-0"
        >
          <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-3 border-b">
            <DialogTitle className="text-lg sm:text-xl font-bold">
              Detail Gedung -{" "}
              {dialogParams && kawasanDisplayMap[dialogParams.kawasan]} (
              {dialogParams?.bulan} {selectedYear})
            </DialogTitle>
            <DialogDescription className="text-sm">
              Periode {dialogParams?.period}: {dialogParams?.status} -{" "}
              {dialogParams?.count} Gedung
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex-1 overflow-auto px-4 sm:px-6">
            {dialogLoading ? (
              <div className="py-4 space-y-4">
                ...
                <div className="border rounded-lg overflow-hidden">
                  ...
                  {[...Array(8)].map((_, i) => (
                    <div
                      key={i}
                      className="flex gap-2 p-3 border-b last:border-b-0"
                    >
                      <Skeleton className="h-5 w-[60px]" />
                      <Skeleton className="h-5 w-[120px]" />
                      <Skeleton className="h-5 flex-1" />
              ...
              <div className="text-center py-12 text-gray-500">
                {dialogSearch
                  ? "Tidak ada gedung yang sesuai dengan pencarian"
                ...
                <Table>
                  <TableHeader className="sticky top-0 bg-white z-10 shadow-sm">
                    <TableRow>
                      ...
                      <TableHead className="w-[100px] sm:w-[130px] text-center">
                        P1-20
                      </TableHead>
                      <TableHead className="w-[100px] sm:w-[130px] text-center">
                        P21-30
                  ...
                  <TableBody>
                    {filteredDialogData.map((item, idx) => (
                      <TableRow key={idx} className="hover:bg-gray-50">
                        ...
                        <TableCell className="text-center">
                          <span
                            className={`inline-flex px-1.5 sm:px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ${
                              item.period_1_20 === "OPEN"
                        ...
                        <TableCell className="text-center">
                          <span
                            className={`inline-flex px-1.5 sm:px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ${
                              item.period_21_30 === "APPROVED"
                                ? "bg-green-100 text-green-700"
                                : item.period_21_30 === "NOT APPROVED"
                                ? "bg-red-100 text-red-700"
                                : item.period_21_30 === "ERROR"
                                ? "bg-yellow-100 text-yellow-700"
                                : item.period_21_30 === "NOT FOUND"
                                ? "bg-orange-100 text-orange-700"
                                : item.period_21_30 === "NONE"
                                ? "bg-gray-200 text-gray-700"
                                : "bg-gray-100 text-gray-600"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 px-4 sm:px-6 py-3 sm:py-4 border-t rounded-xl text-xs sm:text-sm text-gray-600 bg-gray-50">
              <span>
                ...
                <span className="font-semibold">
                  {filteredDialogData.length}
                </span>{" "}
                dari <span className="font-semibold">{dialogData.length}</span>{" "}
                gedung
              </span>
